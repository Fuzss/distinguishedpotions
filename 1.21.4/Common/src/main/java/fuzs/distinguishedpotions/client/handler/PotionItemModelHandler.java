...
public class PotionItemModelHandler {
    ...
    public static EventResultHolder<UnbakedModel> onModifyUnbakedModel(ModelResourceLocation modelLocation, Supplier<UnbakedModel> unbakedModel, Function<ModelResourceLocation, UnbakedModel> modelGetter, BiConsumer<ResourceLocation, UnbakedModel> modelAdder) {
        ...
        if (POTION_MODEL_LOCATIONS.contains(modelLocation) && unbakedModel.get() instanceof ItemModel itemModel) {
            registerPotionOverride(itemModel,
                    DistinguishedPotionsClient.ITEM_MODEL_PROPERTY_STRONG,
                    modelLocation.id());
            registerPotionOverride(itemModel, DistinguishedPotionsClient.ITEM_MODEL_PROPERTY_LONG, modelLocation.id());
    ...
    private static void registerPotionOverride(ItemModel itemModel, ResourceLocation itemModelProperty, ResourceLocation modelLocation) {
        registerItemOverride(itemModel, itemModelProperty, getOverrideModelLocation(modelLocation, itemModelProperty));
    }
